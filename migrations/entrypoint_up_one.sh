...
goose -dir ./migrations postgres "user=$CREDS_SERVICE_POSTGRES_USER password=$CREDS_SERVICE_POSTGRES_PASSWORD dbname=$CREDS_SERVICE_POSTGRES_DB host=$CREDS_SERVICE_POSTGRES_HOST port=$CREDS_SERVICE_POSTGRES_PORT sslmode=disable" up 1